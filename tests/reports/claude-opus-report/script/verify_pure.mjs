// Pure JS version of the verification script
...
function verifyScenarioA() {
  ...
  for (let i = 1; i < details.length; i++) {
    if (details[i].paymentAmount !== firstPayment && details[i].paymentAmount !== details[i-1].paymentAmount + details[i].principalBalance) { 
